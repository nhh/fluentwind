  ...
  'inline-flex items-center justify-center font-semibold shrink-0',
  {
    variants: {
      size: {
        ...
        small: 'h-5 min-w-5 px-s text-100 leading-100',
        medium: 'h-6 min-w-6 px-s text-200 leading-200',
        large: 'h-7 min-w-7 px-m text-200 leading-200',
        extraLarge: 'h-8 min-w-8 px-m text-300 leading-300',
      },
      shape: {
...
const colorMap: Record<string, Record<string, string>> = {
  filled: {
    ...
    important: 'bg-neutral-foreground-1 text-neutral-background-1 dark:border dark:border-neutral-stroke-2',
    informative: 'bg-neutral-background-5 text-neutral-foreground-3 dark:bg-neutral-background-6 dark:text-neutral-foreground-1',
    severe: 'bg-status-warning-background-3 text-status-warning-foreground-3',
    subtle: 'bg-neutral-background-1 text-neutral-foreground-1 dark:bg-neutral-background-6 dark:border dark:border-neutral-stroke-1',
  ...
  ghost: {
    brand: 'text-brand-foreground-1 dark:border dark:border-brand-stroke-2',
    danger: 'text-status-danger-foreground-1 dark:border dark:border-status-danger-stroke-1',
    important: 'text-neutral-foreground-1 dark:border dark:border-neutral-stroke-2',
    informative: 'text-neutral-foreground-3 dark:border dark:border-neutral-stroke-2',
    severe: 'text-status-warning-foreground-1 dark:border dark:border-status-warning-stroke-1',
    subtle: 'text-neutral-foreground-2 dark:border dark:border-neutral-stroke-2',
    success: 'text-status-success-foreground-1 dark:border dark:border-status-success-stroke-1',
    warning: 'text-status-warning-foreground-1 dark:border dark:border-status-warning-stroke-1',
  },
  outline: {
