    ...
    <div className="relative inline-block">
      ...
      {visible && (
        <div
          ...
          role="tooltip"
          className={cn(
            'absolute z-50 rounded-small shadow-4 px-xs py-xxs text-100 leading-100 whitespace-nowrap pointer-events-none animate-[fw-fade-slide-in_100ms_var(--ease-decelerate-mid)]',
