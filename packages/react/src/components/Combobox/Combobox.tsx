  ...
  (
    ...
    return (
      <div ref={wrapperRef} className={cn('relative inline-block', className)}>
        <span className={cn('fw-input-underline inline-flex items-center gap-xxs w-full transition-colors duration-fast', appearanceClasses[appearance], sizeClasses[size], disabled && 'opacity-50 cursor-not-allowed')}>
          <input
            ref={ref}
            role="combobox"
            aria-expanded={open}
